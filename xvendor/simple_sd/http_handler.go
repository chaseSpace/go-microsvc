...
func handleRegister(w http.ResponseWriter, r *http.Request) {
	...
	defer func() {
		...
		instances, hash, _ := Sd.Discovery(context.TODO(), req.Name, "")
		Sdlogger.Debug("handleRegister successful, dur:%dms service:%s req:[%s] instances:%+v Hash:%s", time.Since(st).Milliseconds(), req.Name, req.Addr(), instances, hash)
	}()
...
func handleDiscovery(w http.ResponseWriter, r *http.Request) {
	...
	Sdlogger.Debug("handleDiscovery Start, body:%+v", body)
