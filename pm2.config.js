...
module.exports = {
    apps: [{
        ...
        {
            name: "crontask-QueryEventOrder",
            script: ".bin/crontask QueryEventOrder",
            instances: 1,
            log_date_format: "YYYY-MM-DD HH:mm:ss",
            env_beta: {
                MICRO_SVC_ENV: "beta",
        ...
        {
            name: "crontask-InstagramSpider",
            script: ".bin/crontask InstagramSpider",
            instances: 1,
            log_date_format: "YYYY-MM-DD HH:mm:ss",
            env_beta: {
                MICRO_SVC_ENV: "beta",
